                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList}" varStatus="status">
					<tr>
						...
						<%--<span><a class="deleteUser" href="javascript:;" userid=${user.id } username=${user.userName }><img src="${pageContext.request.contextPath }" alt="删除" title="删除" onclick="del(${user.id })"/></a></span>--%>
						<%--</td>--%>
						<td>
								<span><a class="viewUser" href="javascript:;" userid=${user.id } username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
							...
							<span><a class="modifyUser" href="/user/usermodift.html?userid=${user.id }" username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
							<%--<span><a class="deleteUser" href="/user/deluser/${user.id}" username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>--%>
